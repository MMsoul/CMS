<%@page import="com.huangwei.cms.enums.Gender"%>
			...
			<div class="col-md-6">
				<div class="passport_panel">
					<div class="card">
					  ...
					  <div class="card-body">
					    <form:form modelAttribute="userForm" action="/user/login" class="form-inline" method="post">
					    	...
					    	<p class="w-100" align="right">如果没有帐号，请<a href="/user/reg">点这里注册</a></p>
					    </form:form>
